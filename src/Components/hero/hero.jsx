    ...
    <div className="main_hero">
      <div id="home" className="hero">
        ...
        <div className="bluring">
          <div className="card">
            <a
              ...
              target="_blank"
              href="https://github.com/hariharann650"
            >
              <svg
                viewBox="0 0 496 512"
                height="1em"
            ...
            <a
              ...
              target="_blank"
              href="https://www.linkedin.com/in/hariharandeveloper/"
            >
              <svg
                fill="#fff"
                viewBox="0 0 448 512"
            ...
            <a
              className="social-link social-link6"
              target="_blank"
              href="https://wa.me/918072114401"
            >
              <svg
                viewBox="0 0 16 16"
        ...
        <div className="hero-action">
          ...
          <a className="anchorlink" href="" download={resume}>
